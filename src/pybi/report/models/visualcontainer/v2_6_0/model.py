...
class VisualContainer(BaseModel):
    ...
    field_schema: Literal['https://developer.microsoft.com/json-schemas/fabric/item/report/definition/visualContainer/2.6.0/schema.json'] | None= Field(None, alias='$schema', description='Defines the schema to use for an item.'
    )
    ...
    visual: SchemaEmbedded | None= Field(None, description='Defines a chart to be shown inside of this container.'
    )
    ...
    filterConfig: SchemaEmbeddedModel | None= Field(None,
    ...
    howCreated: HowCreated | None= Field(None, description='Source of creation of this visual.'
    )
