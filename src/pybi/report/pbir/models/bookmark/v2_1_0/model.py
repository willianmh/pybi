...
from ...bookmark.v1_4_0.model import DataTable, FilterLabelIdPair, JsonFilter, VisualContainerDisplayMode
...
class Bookmark(BaseModel):
    ...
    field_schema: Literal['https://developer.microsoft.com/json-schemas/fabric/item/report/definition/bookmark/2.1.0/schema.json'] = Field(
...
class DataViewObjectPropertyIdWithSelector(BaseModel):
    ...
    selector: Selector | None= Field(None, description='Scope at which to apply this change.'
    )
