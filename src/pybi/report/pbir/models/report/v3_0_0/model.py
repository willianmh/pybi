...
class ThemeVersion(BaseModel):
    ...
    visual: Annotated[str, StringConstraints(pattern=r"^[0-9]+\.[0-9]+\.[0-9]+$")] = (
        Field(..., description="The max visual container version at import.")
    )
    page: Annotated[str, StringConstraints(pattern=r"^[0-9]+\.[0-9]+\.[0-9]+$")] = (
        Field(..., description="The max page version at import.")
    )
    report: Annotated[str, StringConstraints(pattern=r"^[0-9]+\.[0-9]+\.[0-9]+$")] = (
        Field(..., description="The max report version at import.")
    )
