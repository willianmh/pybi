...
from ...report.v3_0_0.model import ExportDataMode, PagesPosition, QueryLimitOption, ReportSource, ResourcePackageItemType, ResourcePackageType, ThemeMetadata
...
class Report(BaseModel):
    ...
    field_schema: Literal['https://developer.microsoft.com/json-schemas/fabric/item/report/definition/report/3.2.0/schema.json'] = Field(
