...
class VisualContainerMobileState(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    field_schema: Literal['https://developer.microsoft.com/json-schemas/fabric/item/report/definition/visualContainerMobileState/2.2.0/schema.json'] = Field(
...
VisualContainerMobileState.model_rebuild()
