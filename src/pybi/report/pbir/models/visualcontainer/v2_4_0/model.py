...
from ...visualconfiguration.v2_2_0.model import (
...
class VisualContainer(BaseModel):
    ...
    field_schema: (
        ...
        None, alias="$schema", description="Defines the schema to use for an item."
    )
    name: Annotated[str, StringConstraints(max_length=50)] | None = Field(
        None, description="A unique identifier for the visual across the whole page."
    )
    position: VisualContainerPosition | None = Field(
        None,
    ...
    visual: VisualConfiguration | None = Field(
        None, description="Defines a chart to be shown inside of this container."
    )
...
class SchemaEmbedded(BaseModel):
    ...
    objects: dict[str, list[DataViewObjectDefinition]] | None = Field(
        None,
...
class RoleProjection(BaseModel):
    ...
    format: Annotated[str, StringConstraints(max_length=255)] | None = Field(
        None, description="format string scoped to the visual."
    )
...
class RoleFieldParameter(BaseModel):
    ...
    sortDirection: SortDirectionModel | None = Field(
        None,
...
class FilterContainer(BaseModel):
    ...
    howCreated: HowCreated2 | None = Field(
