...
from ...visualcontainer.v2_3_0.model import GroupLayoutMode, HowCreated2
...
class VisualContainerPosition(BaseModel):
    ...
    tabOrder: float | None= Field(None,
...
class VisualContainer(BaseModel):
    ...
    field_schema: Literal['https://developer.microsoft.com/json-schemas/fabric/item/report/definition/visualContainer/2.4.0/schema.json'] | None= Field(None, alias='$schema', description='Defines the schema to use for an item.'
    )
    name: Annotated[str, StringConstraints(max_length=50)] | None= Field(None, description='A unique identifier for the visual across the whole page.'
    )
    position: VisualContainerPosition | None= Field(None,
    ...
    visual: VisualConfiguration | None= Field(None, description='Defines a chart to be shown inside of this container.'
    )
    visualGroup: VisualGroupConfig | None= Field(None,
        description='Defines that this container should be used as a grouping container.',
    )
    parentGroupName: str | None= Field(None,
        description='Name of the parent group (visual container), if it is part of one.',
    )
    filterConfig: dict[str, Any] | None= Field(None,
    ...
    howCreated: str | None= Field(None, description='Source of creation of this visual.'
    )
...
class SchemaEmbeddedModel(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
...
class FilterContainer(BaseModel):
    ...
    howCreated: HowCreated2 | None= Field(None, description='Specifies how this filter was first created.'
    )
...
class VisualGroupConfig(BaseModel):
    ...
    objects: VisualGroupFormattingObjects | None= Field(None,
...
SchemaEmbeddedModel.model_rebuild()
