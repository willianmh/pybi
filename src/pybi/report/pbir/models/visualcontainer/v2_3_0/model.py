...
class VisualContainer(BaseModel):
    ...
    field_schema: Literal['https://developer.microsoft.com/json-schemas/fabric/item/report/definition/visualContainer/2.3.0/schema.json'] | None= Field(None, alias='$schema', description='Defines the schema to use for an item.'
    )
